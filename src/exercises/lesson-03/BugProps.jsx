...
// Explanation:
// message was stored as a regular variable so React couldn't track changes to it.
// Moving it into useState means React watches it and updates the screen when it changes.
